...
def evaluate_tiered(model, eval_dataloader, device, metrics, seg_mode=False, return_softmax=False, return_explanations=False, return_losses=False, verbose=True,dep_graphs=None, label_entities=None, graph_labels=None,cn_nb=None):
  if verbose:
    print('\tBeginning evaluation...')
  ...
  for step, batch in enumerate(eval_dataloader):
    ...
    if seg_mode:
      ...
      segment_ids = None
    dep_graphs_i = dep_graphs[step]
    labels_entities_i = label_entities[step]
    graph_labels_i = graph_labels[step]
